...
const NewDetailsform = ({ closeModal }) => {
    ...
    }, [title, category, numCandidates, candidates]);
                    ...
                    <View style={styles.modalContent}>
                        <View style={styles.headerMainContainer}>
                            <View style={styles.headerInnerContainer}>
                                <Text style={styles.textHeader}>Fill out voting details form</Text>
                            </View>
                        ...
                        <ScrollView contentContainerStyle={styles.scrollContainer}>
                            ...
                            <View style={styles.namesContainer}>
                                {Array.from({ length: parseInt(numCandidates, 10) || 0 }, (_, index) => (
                                    <View key={index} style={styles.nameInputContainer}>
                                        <Text style={styles.textNames}>{`Candidate #${index + 1}`}</Text>
                                        <View style={styles.inputContainerNames}>
                                            <TextInput
                                                ...
                                                onChangeText={(text) => handleCandidatesChange(text, index)}
                                            />
                                        </View>
                                    </View>
                                ))}
                        ...
                        <View style={styles.btnContainer}>
                            <TouchableOpacity
                                style={[styles.submitButton, isFormValid ? styles.activeSubmitButton : styles.disabledSubmitButton]}
                                onPress={handleSubmission}
                                disabled={!isFormValid}
                            >
                                <Text style={[styles.submitButtonText, {  color: isFormValid ? 'white' : '#5c6b73' }]}>SUBMIT VOTE</Text>
